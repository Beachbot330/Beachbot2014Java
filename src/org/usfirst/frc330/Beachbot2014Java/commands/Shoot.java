...
public class  Shoot extends Command implements AutoSpreadsheetCommand{
    ...
    protected void initialize() {
        ...
        shootOnTimer = Robot.wings.getWingOpenTime() + Robot.arm.armWaitWings();
        if (Robot.wings.areWingsOpen() && Timer.getFPGATimestamp() > shootOnTimer && Robot.shooter.isBallInShooter()) {
//        solenoidOffTime = Robot.shooter.shootSolenoidOffTime() + Timer.getFPGATimestamp();
    ...
    protected void execute() {
        if (Robot.wings.areWingsOpen() && Timer.getFPGATimestamp() > shootOnTimer && Robot.shooter.isBallInShooter() && shooterOn == false) {
            Robot.shooter.shootSolenoidOn();
            shootOffTimer = Timer.getFPGATimestamp() + Robot.shooter.shootSolenoidOffTime();
            shooterOn = true;
