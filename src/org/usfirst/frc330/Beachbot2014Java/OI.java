...
public class OI {
    ...
    public JoystickButton loadShooterReverseButton;
    ...
    public OI() {
        ...
        pickupForwardButton.whenPressed(new AutoPickupForward());
        ...
        pickupReverseButton.whenPressed(new AutoPickupReverse());
        ...
        loadShooterReverseButton = new JoystickButton(operatorJoystick, 4);
        loadShooterReverseButton.whenPressed(new AutoLoadShooterRear());
        ...
        SmartDashboard.putData("MoveArmToZeroPosition", new MoveArmToZeroPosition());
