...
public class OI {
    ...
    public JoystickButton armPickupButton;
    public JoystickButton wingsToggleButton2;
    ...
    public OI() {
        ...
        wingsToggleButton2 = new JoystickButton(operatorJoystick, 8);
        wingsToggleButton2.whenPressed(new WingsToggle());
        armPickupButton = new JoystickButton(operatorJoystick, 2);
        armPickupButton.whenPressed(new AutoPickupForward());
        pickupForwardButton = new JoystickButton(operatorJoystick, 1);
        pickupForwardButton.whenPressed(new PickupForwardPulse());
        pickupOffButton = new JoystickButton(operatorJoystick, 3);
        pickupOffButton.whenPressed(new PickupOff());
        wingsToggleButton = new JoystickButton(operatorJoystick, 6);
        ...
        loadShooterButton = new JoystickButton(operatorJoystick, 4);
        ...
        SmartDashboard.putData("ArmPickupPosition", new ArmPickupPosition());
        SmartDashboard.putData("ArmBumperPosition", new ArmBumperPosition());
        SmartDashboard.putData("ArmLoadingPosition", new ArmLoadingPosition());
        SmartDashboard.putData("ArmCatchingPosition", new ArmCatchingPosition());
        ...
        SmartDashboard.putData("OppositeArmBumperPosition", new OppositeArmBumperPosition());
        SmartDashboard.putData("OppositeArmCatchingPosition", new OppositeArmCatchingPosition());
        SmartDashboard.putData("OppositeArmLoadingPosition", new OppositeArmLoadingPosition());
