...
public class OI {
    ...
    public JoystickButton pickupOnButton;
    ...
    public OI() {
        ...
        pickupOffButton = new JoystickButton(operatorJoystick, 2);
        pickupOffButton.whenPressed(new PickupOff());
        pickupOnButton = new JoystickButton(operatorJoystick, 1);
        pickupOnButton.whenPressed(new PickupOn());
