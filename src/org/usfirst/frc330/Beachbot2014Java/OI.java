...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("MoveArmToFrontCheckBallSlow", new MoveArmToFrontCheckBallSlow());
        SmartDashboard.putData("MoveArmToRearCheckBallSlow", new MoveArmToRearCheckBallSlow());
        SmartDashboard.putData("MoveArmToCloseCheckBallSlow", new MoveArmToCloseCheckBallSlow());
        SmartDashboard.putData("DropBall", new DropBall());
