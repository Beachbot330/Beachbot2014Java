...
public class OI {
    ...
    public JoystickButton safeButton2;
    ...
    public OI() {
        ...
        safeButton2 = new JoystickButton(operatorJoystick, 2);
        safeButton2.whenReleased(new MoveArmToCloseSafePosition());
        ...
        pickupFarButton = new JoystickButton(operatorJoystick, 3);
        pickupFarButton.whenPressed(new AutoPickupFar());
        ...
        pickupOffButton.whileHeld(new PickupReverseFancy());
        safeButton = new JoystickButton(operatorJoystick, 3);
        safeButton.whenReleased(new MoveArmToCloseSafePosition());
        ...
        SmartDashboard.putData("PickupReverseFancy", new PickupReverseFancy());
