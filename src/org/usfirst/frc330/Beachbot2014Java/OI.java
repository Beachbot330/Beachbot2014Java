...
public class OI {
    ...
    public JoystickButton autoTrussCatchButton;
    ...
    public OI() {
        ...
        shooterEjectButton = new JoystickButton(operatorJoystick, 11);
        shooterEjectButton.whenPressed(new ShooterEject());
        armEjectButton = new JoystickButton(operatorJoystick, 12);
        armEjectButton.whenPressed(new MoveArmToVerticalPosition());
        ...
        autoTrussCatchButton = new JoystickButton(leftJoystick, 1);
        autoTrussCatchButton.whenPressed(new AutoTrussCatch());
