...
public class RobotMap {
	...
	LiveWindow.addActuator("Chassis", "RightDrive3", (Talon) chassisRightDrive3);
        ...
        chassisCompressor = new Compressor(1, 1, 1, 1);
	
        
        chassisShiftSolenoid = new DoubleSolenoid(1, 1, 2);      
	
        
        chassisLeftDriveEncoder = new Encoder(1, 2, 1, 3, false, EncodingType.k4X);
	LiveWindow.addSensor("Chassis", "LeftDriveEncoder", chassisLeftDriveEncoder);
        ...
        chassisRightDriveEncoder = new Encoder(1, 4, 1, 5, false, EncodingType.k4X);
