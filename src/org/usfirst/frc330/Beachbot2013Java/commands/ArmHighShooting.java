 ...
 * turn off shooter
 *
 * Revision 1.10  2013-03-24 17:49:55  jross
...
public class  ArmHighShooting extends Command implements AutoSpreadsheetCommand {
    ...
    //TODO check if arm is climbing position and put pickup down if it is before moving arm. This is similar to ArmLowPickup and ArmLowShooting
    // Called just before this Command runs the first time
    protected void initialize() {
        Robot.shooterLow.shoot(0);
        Robot.arm.armSetPointHighShooting();
        Robot.arm.enable();
