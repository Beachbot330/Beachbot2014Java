 ...
 * Revision 1.5  2013-03-28 04:47:41  jross
 * revert previous committ. message made no sense
 *
 ...
 *
 */
public class  ShootLowStableOutput extends Command implements AutoSpreadsheetCommand {
    public ShootLowStableOutput() {
    ...
    protected void execute() {
        if (Robot.shooterLow.getSpeed() < Robot.shooterLow.getShootLowSetpoint() - Robot.shooterLow.getShootLowOutputSetpointBelow())
        {
            Robot.shooterLow.shoot(1);
        }
        else
        {
            Robot.shooterLow.shoot(Robot.shooterLow.getShootLowOutput());
        }
    ...
    public Command copy() {
        return new ShootLowStableOutput();
    }
}
