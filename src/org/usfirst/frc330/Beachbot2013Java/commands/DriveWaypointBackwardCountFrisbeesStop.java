 ...
 * @author Joe
 */
public class DriveWaypointBackwardCountFrisbeesStop extends DriveWaypointBackward {

    public DriveWaypointBackwardCountFrisbeesStop(double x, double y, double tolerance, double timeout, boolean stopAtEnd) {
        super(x, y, tolerance, timeout, stopAtEnd);
    }

    protected boolean isFinished() {
        return super.isFinished() || Robot.frisbeePickup.getFrisbeeCount() >= 4;
    }
    
    

    public Command copy() {
        return new DriveWaypointBackwardCountFrisbeesStop(0,0,0,0,true);
    }
