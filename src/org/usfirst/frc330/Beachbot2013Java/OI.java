...
/*
 * $Log: OI.java,v $
 * Revision 1.30  2013-03-28 03:47:56  jross
 * remove shoot high and fix robotbuilder links for climbing
 *
 * Revision 1.29  2013-03-26 05:41:44  jross
 * add action item for fixing robot builder and move shooting to driver joystick
 *
...
public class OI {
    ...
    public OI() {
        ...
        manualArmButton = new JoystickButton(operatorJoystick, 3);
        ...
        SmartDashboard.putData("LiftRobotCommandGroup", new LiftRobotCommandGroup());
        SmartDashboard.putData("ArmPastClimbing", new ArmPastClimbing());
