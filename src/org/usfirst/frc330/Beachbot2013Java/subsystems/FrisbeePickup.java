...
public class FrisbeePickup extends Subsystem {
    ...
    SpeedController transferController = RobotMap.frisbeePickupTransferController;
...
//        setDefaultCommand(new PickupUp());
    ...
    public void initializeFrisbeeTransfer()
    {
        if (!Preferences.getInstance().containsKey("FrisbeeTransferMotorOutput"))
        {
            Preferences.getInstance().putDouble("FrisbeeTransferMotorOutput", 0.9);
            Preferences.getInstance().save();
        }
    }
...
//        System.err.println("setFrisbeePickupMotorPickup");
    ...
    public void setFrisbeeTransferOutput()
    {
        transferController.set(Preferences.getInstance().getDouble("FrisbeeTransferMotorOutput", 0.9));
    }
