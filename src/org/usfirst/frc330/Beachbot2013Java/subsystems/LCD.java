...
public class LCD extends Subsystem {
    ...
    private CFA634SPI lcdDevice = null;
    ...
    public LCD()
    {
        lcdDevice = new CFA634SPI(clk, mosi, null, cs);
        lcd = new SmartDashboardLCD(lcdDevice);
        SmartDashboard.putNumber("Gyro Angle", 0);
        SmartDashboard.putNumber("Batt Voltage", 0);
        lcd.addLine(Line.kUser1, "Batt Voltage");
        lcd.addLine(Line.kUser2, "angleToCenter");
        lcd.addLine(Line.kUser3, "distanceToCenter");
        lcd.addLine(Line.kUser4, "Gyro Angle");
