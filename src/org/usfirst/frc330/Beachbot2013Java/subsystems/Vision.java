...
//    }
    ...
    int visionPosition = 1;
    public void getVisionPosition()
    {
        if (DriverStation.getInstance().isFMSAttached() && DriverStation.getInstance().getAlliance() == DriverStation.Alliance.kRed)
        {
...
//                System.out.println("X " + x + " lX " + leftx + " rX " + rightx + " lY " + lefty + " rY " + righty);
    ...
    double minDistance[]= {0,0,0,0}, minAngle;
    public double getMinDistance() {
        return minDistance[visionPosition];
    }
    public double getMinAngle() {
        return minAngle;
    }
    public double getMaxDistance() {
        return maxDistance[visionPosition];
    }
    public double getMaxAngle() {
        return maxAngle;
    }
    double maxDistance[]= {0,0,0,0}, maxAngle;
    public void readVisionFile()
    {
        try {
            ...
            int comma1;
            int lineCount=0;
            double x1=0, x2=0, x3=0, x4=0, y1=0;
            ...
            {
                comma1 = line.indexOf(",");
                x1 = Double.parseDouble(line.substring(0,comma1).trim());
                line = line.substring(comma1+1);
                comma1 = line.indexOf(",");
                x2 = Double.parseDouble(line.substring(0,comma1));
                line = line.substring(comma1+1);
                comma1 = line.indexOf(",");
                x3 = Double.parseDouble(line.substring(0,comma1));
                line = line.substring(comma1+1);
                comma1 = line.indexOf(",");
                x4 = Double.parseDouble(line.substring(0,comma1));
                line = line.substring(comma1+1);
                comma1 = line.indexOf(",");
